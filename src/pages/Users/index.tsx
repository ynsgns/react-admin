...
function Users() {
  ...
  const handleChangeFormData = (prop: any) => (e: any) => {
    setFormDataValidate({
      name: false,
      email: false,
      phoneNumber: false,
  ...
  return (
    <div>
      ...
      >
        ...
        {selectedTab == 1 && (
          <Paper style={{ height: "70vh", padding: "20px 10px" }}>
            <Grid container spacing={2}>
              <Grid item xs={12} md={12}>
                <TextField
                  ...
                  helperText={
                    formDataValidate.name == true && "İsim ve soyisim zorunlu."
                  }
                  required
                />
              </Grid>
              <Grid item xs={12} md={12}>
                <TextField
                  ...
                  helperText={
                    formDataValidate.email == true && "E-mail zorunlu."
                  }
                />
              </Grid>
              <Grid item xs={12} md={12}>
                <TextField
                  ...
                  helperText={
                    formDataValidate.phoneNumber == true &&
                    "Telefon numarsı zorunlu."
                  }
                />
              </Grid>
              <Grid item xs={12} md={12}>
